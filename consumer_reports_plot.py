...
Not sure how to pass in colormap but 'plt.cm.Wistia' is what is used in the function body
'''

def cr_plot(data, row_labels, column_labels, output_path, default_val=0, width=15, colormap=None, graph_aspect=0.15):
    if len(row_labels) < 2:
    ...
    cmap = plt.cm.Wistia if colormap is None else colormap # find out how to pass in colormap
    ...
    for i, ax in enumerate(axes):
        ...
        im = ax.imshow(dat, cmap="Wistia", aspect=0.3)
